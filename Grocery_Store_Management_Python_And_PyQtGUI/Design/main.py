...
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterBG import EnterBGCLass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterDHB import EnterDHBClass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterDHM import EnterDHMClass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterDSHH import EnterDSHHClass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterDVT import EnterDVTClass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterNCC import EnterNCCClas
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterNV import EnterNVClass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.EnterXacNhan import Xac_Nhan
from Grocery_Store_Management_Python_And_PyQtGUI.Design.Login import EnterLoginClass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.RegisterForm import EnterRegisterFromClass
from Grocery_Store_Management_Python_And_PyQtGUI.Design.SelectDH import SelectDHClass
from Grocery_Store_Management_Python_And_PyQtGUI.Functions.Face_Regconition_ComputerVison.recognition import FaceRecognition
from ui_main import *
import datetime
...
class MainWindow(QMainWindow):
    ...
    def searchBar_DVT(self):  # Search data functions
        ...
        self.cursor.execute("SELECT STT, MaDVT, TenDVT, GhiChu FROM Don_Vi_Tinh WHERE TenDVT LIKE ?",
                            ('%' + search_term + '%',))
...
class Login(QWidget):
    ...
    def __init__(self):
        ...
        # If FaceIDButton clicked, Face_Regconition_ComputerVison GUI will appear
