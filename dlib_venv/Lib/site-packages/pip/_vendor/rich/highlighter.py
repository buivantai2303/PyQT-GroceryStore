...
class Highlighter(ABC):
    ...
    def __call__(self, text: Union[str, Text]) -> Text:
        """Highlight a str or Text.txt instance.

        Args:
            text (Union[str, ~Text.txt]): Text.txt to highlight.
        ...
        if isinstance(text, str):
            ...
            raise TypeError(f"str or Text.txt instance required, not {text!r}")
    ...
    def highlight(self, text: Text) -> None:
        ...
        Args:
            text (~Text.txt): A text object highlight.
        """
...
class RegexHighlighter(Highlighter):
    ...
    def highlight(self, text: Text) -> None:
        """Highlight :class:`rich.text.Text.txt` using regular expressions.

        Args:
            text (~Text.txt): Text.txt to highlighted.
